(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new swiper_core_Swiper(".about-us__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3.5,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".about-us__slider  .swiper-button-prev",
                    nextEl: ".about-us__slider  .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            var swiperTrailer = new swiper_core_Swiper(".trailer-product__slider-thumb", {
            ...
            new swiper_core_Swiper(".trailer-product__slider", {
                modules: [ Navigation, Thumb ],
                observer: true,
                observeParents: true,
                spaceBetween: 10,
                navigation: {
                    nextEl: ".trailer-product-slider .swiper-button-next",
                    prevEl: ".trailer-product-slider .swiper-button-prev"
                },
                thumbs: {
                    swiper: swiperTrailer
                }
            });
        }
    }
    ...
    const openPhoneDropdown = () => {
        const button = document.querySelector(".phone-dropdown__button");
        ...
        document.addEventListener("click", (function(event) {
            if (!dropdown.contains(event.target) && !button.contains(event.target)) closeDropdown();
        }));
    ...
    class StarRating {
        ...
        updateRating(e) {
            ...
            this.ratings.forEach((rating => {
                ...
                if (this.rating.id !== id) ratingTextEl.setAttribute("hidden", true); else ratingTextEl.removeAttribute("hidden");
            }));
        }
    }
    const showMoreButton = document.querySelector(".button-show-more");
    const reviewElements = document.querySelectorAll(".info-reviews__list .review");
    let script_isHidden = true;
    let visibleCount = 2;
    showMoreButton.addEventListener("click", (e => {
        e.preventDefault();
        if (script_isHidden) {
            reviewElements.forEach(((review, index) => {
                if (index >= visibleCount) review.removeAttribute("hidden");
            }));
            showMoreButton.textContent = "Hide Less";
        } else {
            reviewElements.forEach(((review, index) => {
                if (index >= visibleCount) review.setAttribute("hidden", true);
            }));
            showMoreButton.textContent = "Show More";
        }
        script_isHidden = !script_isHidden;
    }));
    Fancybox.bind('[data-fancybox="galleryDetails"]', {});
    openPhoneDropdown();
    window["FLS"] = true;
    isWebp();
    menuInit();
